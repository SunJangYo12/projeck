...
public class KalActivity extends Activity {  
    ...
    public void onCreate(Bundle savedInstanceState) {  
        ...
        setContentView(R.layout.activity_kalen);  
    ...
    private void updateDisplay(int y, int m, int d) {  
        ...
        int jumlah_baris = 6;  
        if ( (((endday - startday) % 6) == 0) || (m==1)) jumlah_baris = 5;  
        ...
        for(int i = 0; i < jumlah_baris;i++){  
            ...
            for(int j=1;j<8;j++){  
                ...
                if(idx==1) {  
                    if(j < startday) nocontent = true;else nocontent = false;  
                } else {  
                    if(tgl <= endday) nocontent = false; else nocontent = true;  
                }  
