...
function redraw() {
  ...
  drawEllipse(x + 47, y - 68 - breathAmt, 8, curEyeHeight); // mata kiri
  drawEllipse(x + 58, y - 68 - breathAmt, 8, curEyeHeight); // mata kanan
